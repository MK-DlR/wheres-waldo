  ...
  return (
    <>
      ...
      <div className="card">
        ...
        />
        <p className="footer">
          <a href="https://github.com/MK-DlR">Created by <i class="fa-brands fa-github" /> MK-DlR</a>
          <br></br>
          <a href="https://www.debutart.com/artist/laurie-greasley/the-raid">The Raid by Laurie Greasley</a>
        </p>
      </div>
    </>
  )
